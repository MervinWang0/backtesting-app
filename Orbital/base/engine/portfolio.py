...
from base.models import (BacktestRun, BenchmarkRecord, PortfolioEquityRecord,
                         PortfolioPositionRecord, PortfolioFillRecord, Stock,
                         StockPriceHistory, ForexPair, ForexPriceHistory)
...
class Portfolio:
    ...
    def update_position_tracker(self, ticker: str, curr_quantity: float,
                                fill_quantity: float, fill_price: float, commission: float) -> float:
