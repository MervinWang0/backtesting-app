...
def execute_order(user , account_id: int, ticker : str, type : str, qty : Decimal):
     ...
     try:
          with transaction.atomic():
               ...
               print("ORDER TYPE:", repr(type))
               print("PREVIOUS QUANTITY:", prev_qty)
               print("PREVIOUS AVG COST:", prev_entry_price)
               print("TRADE QUANTITY:", qty)
               print("TRADE PRICE:", price)
               print("CLOSED QUANTITY:", position_update.closed_quantity)
               print("OPENED QUANTITY:", position_update.opened_quantity)
               print("NEW QUANTITY:", position_update.new_qty)
               print("NEW AVG COST:", position_update.new_entry_price)
               print("REALISED PNL:", position_update.realised_pnl)
